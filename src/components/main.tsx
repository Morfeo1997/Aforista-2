...
import { getRandomAnimation } from "../animations/index";
...
export default function Main() {
  ...
  console.log(quotes.filter((quote) => !Array.isArray(quote.topics)));
  ...
  const filteredQuotes = useMemo(() => {
    ...
    return quotes.filter((quote) => quote.topics?.includes(selectedTopic));
  ...
  const generateQuote = () => {
    ...
    animation(quoteRef.current!, () => {
      setCurrentQuote(randomQuote);

      setTheme(getThemeFromQuote(randomQuote));
    });
  };

  return (
    <main className="flex font-cookie min-h-screen w-full items-center justify-center px-6 py-10">
      <div
            ...
            {currentQuote ? (
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {(currentQuote.year || currentQuote.source) && (
                    <p
                      className="text-sm"
                      style={{
                        color: "var(--secondary-text)",
